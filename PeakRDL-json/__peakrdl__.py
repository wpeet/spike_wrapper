...
from .exporter import export_rdl_to_json
...
class Exporter(ExporterSubcommandPlugin):  # pylint: disable=too-few-public-methods
    """PeakRDL json exporter plug-in."""

    short_desc = "Generate json"
    long_desc = "Export the register model to json"
